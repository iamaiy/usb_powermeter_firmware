...
uint8_t adc_fresh, cnt_value, navg=30;
uint16_t adc_value;
...
void my_adc_navg_set(uint8_t in){
	// A priori knowledge of signal 1 sample is ~2125 of 4095 full scale 
	// => accumulate up to 30 keeps data in uint16_t without overflow
	navg = in;
}
